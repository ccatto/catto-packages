...
const LinkCatto = forwardRef<HTMLAnchorElement, LinkCattoProps>(
  (
    ...
    const variants: Record<LinkVariantType, string> = {
      ...
      outline: cn(
        "rounded-md border border-theme-primary text-theme-primary font-medium hover:bg-theme-primary-subtle",
        "focus:ring-theme-primary"
      ),
      outline2: cn(
        "rounded-md border-2 border-theme-primary text-theme-primary font-medium hover:bg-theme-primary-subtle",
        "focus:ring-theme-primary"
      ),
      // Orange outline link - secondary (RLeaguez accent)
      outlineOrange: cn(
        "rounded-md border border-theme-secondary text-theme-secondary font-medium hover:bg-theme-secondary-subtle",
