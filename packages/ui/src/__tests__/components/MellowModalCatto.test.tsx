...
describe("MellowModalCatto", () => {
  ...
  describe("height constraint", () => {
    it("always applies max-h-[85vh] to prevent content blowout", () => {
      render(
        <MellowModalCatto isOpen onClose={vi.fn()}>
          Content
        </MellowModalCatto>
    ...
    it("applies max-h-[85vh] even when scrollable is false", () => {
      render(
        <MellowModalCatto isOpen onClose={vi.fn()} scrollable={false}>
          Content
        </MellowModalCatto>
      );
    ...
    it("always applies overflow-y-auto for graceful scrolling", () => {
      render(
        <MellowModalCatto isOpen onClose={vi.fn()}>
          Content
        </MellowModalCatto>
